function [sR step]=icassoEst_infomaxICA(mode,X,M,varargin)
%function sR=icassoEst(mode,X,M,['infomaxICAparamName1',value1,'infomaxICAparamName2',value2,...])
%
%PURPOSE
%
...
%default parameters for infomaxICA: symmetrical approach, kurtosis as
...
%contrast function and the deflatory approach in infomaxICA. Applies
